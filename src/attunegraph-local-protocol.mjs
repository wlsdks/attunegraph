...
export const APPLICATION_ID = ATTUNEGRAPH_PHYSICAL_SCHEMA_V2.applicationId;
export const USER_VERSION = ATTUNEGRAPH_PHYSICAL_SCHEMA_V2.userVersion;
const SUPPORTED_USER_VERSIONS = new Set([1, USER_VERSION]);
...
/** @typedef {{ readonly applicationId: number, readonly profileVersion: 1, readonly protocolVersion: 1, readonly sqliteVersion: string, readonly userVersion: 1 | 2 }} InitializeResult */
  ...
  switch (type) {
    case "initialize": {
      ...
      if (
        ...
        || !SUPPORTED_USER_VERSIONS.has(/** @type {number} */ (input.userVersion))
      ...
      return Object.freeze({
        ...
        userVersion: /** @type {1 | 2} */ (input.userVersion)
      });
    }
    case "read": {
